...
class Api::V1::OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should forbid "show user orders" for unauthenticated users' do
    get api_v1_orders_url, as: :json
    assert_response :forbidden
  end

  test 'should show user orders' do
  ...
  test 'should forbid create order for unauthenticated users' do
  ...
  test 'should create order with 2 products' do
